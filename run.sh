...
# set ChimeraX alias
alias chimerax=/usr/bin/chimerax  # change this to your ChimeraX path
...
chimerax --nogui --cmd 'open 8SOR/8sor.cif; open 8SOR/map_model_difference_1.ccp4; blobus validatus /A:1401'
